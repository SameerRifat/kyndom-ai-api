...
def get_summary_prompt_with_context(recent_message: str) -> str:
    """
    Generates the summary prompt with context based on the recent message.
    
    Args:
        recent_message (str): The most recent user message.
    
    Returns:
        str: The summary prompt with context.
    """
    return f"""
    Previous message: {recent_message}
